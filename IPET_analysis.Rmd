...
med.fit_DP <- lmer (Perspective.response~dummy_img*Detail_C+(dummy_img+Detail_C|participant),data= interaction.df) # one refit
...
med.fit_DP2 <- lmer (Perspective.response~dummy_img+Detail_C+imgdet_int+(dummy_img+Detail_C|participant),data= interaction.df) 
